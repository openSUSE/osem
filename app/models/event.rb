class Event < ActiveRecord::Base
  ...
  def max_attendees_no_more_than_room_size
    return unless selected_schedule_room && max_attendees_changed?
    errors.add(:max_attendees, "cannot be more than the room's capacity (#{selected_schedule_room.size})") if max_attendees && (max_attendees > selected_schedule_room.size)
  end
